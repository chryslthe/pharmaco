...
Проект можно рассматривать как учебный PharmCAT-like прототип.
...
Однако он не является полной заменой PharmCAT, так как использует собственную небольшую базу правил и упрощенные алгоритмы определения diplotypes.
